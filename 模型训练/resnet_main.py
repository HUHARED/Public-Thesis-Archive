...
model.fc = nn.Linear(model.fc.in_features, CLASSNUMBER)
# model._fc.out_features = CLASSNUMBER
# print(model._fc.in_features)
# print("分类数量",model._fc.out_features)

""" 先用 nn.DataParallel试试，能行再用DistributedDataParallel """
...
savePath = "./test4_resnet_epochnumber_"+str(EPOCHNUMBER)+".pkl"
